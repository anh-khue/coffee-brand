...
const BRANCH_ADDRESSES_API_URL = 'http://192.168.100.127:9999/cobra-branch-service/branches';
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <MapView style={{ flex: 1 }} region={this.state.marker}>
          ...
          <MapView.Marker coordinate={this.state.branches[0]}>
            <View><Image source={map_marker_icon} style={{ width: 60, height: 60 }} /></View>
          </MapView.Marker>

          <MapView.Marker coordinate={this.state.branches[1]}>
            <View><Image source={map_marker_icon} style={{ width: 60, height: 60 }} /></View>
          </MapView.Marker>

          <MapView.Marker coordinate={this.state.branches[2]}>
            <View><Image source={map_marker_icon} style={{ width: 60, height: 60 }} /></View>
          </MapView.Marker>
